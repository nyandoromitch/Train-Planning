<?php
  ...
  if(isset($_REQUEST['action'],$_REQUEST['storeshowbearings'],$_REQUEST['storecrosshair'],$_REQUEST['storeclickcenter'],$_REQUEST['storelanguage'],$_REQUEST['storeunits'],$_REQUEST['storestartdate'],$_REQUEST['storeenddate'],$_REQUEST['custom_view'])){
    ...
    if (!is_null($db))
    {
        ...
        $trip              = isset($_REQUEST["trip"]) ? preg_replace("/[^a-zA-Z0-9]/", "", $_REQUEST["trip"]) : "";
        $ID              = isset($_REQUEST["ID"]) ? preg_replace("/[^a-zA-Z0-9]/", "", $_REQUEST["ID"]) : "";
        $username              = isset($_REQUEST["username"]) ? preg_replace("/[^a-zA-Z0-9]/", "", $_REQUEST["username"]) : "";
        $passwprd              = isset($_REQUEST["password"]) ? preg_replace("/[^a-zA-Z0-9]/", "", $_REQUEST["password"]) : "";
        $startday              = isset($_REQUEST["startday"]) ? preg_replace("/[^a-zA-Z0-9]/", "", $_REQUEST["startday"]) : "";
        $endday              = isset($_REQUEST["endday"]) ? preg_replace("/[^a-zA-Z0-9]/", "", $_REQUEST["endday"]) : "";
